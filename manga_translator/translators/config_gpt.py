...
class ConfigGPT:
    ...
    _CHAT_SYSTEM_TEMPLATE = (
        ...
        '2. REFINEMENT: \n'
        '- Adjust the translation to sound natural and colloquial in {to_lang} while maintaining original meaning.\n'
        '- Use everyday conversational language that native speakers actually use in daily life.\n'
        '- Avoid overly formal, literary, or stiff expressions unless the original text is formal.\n'
        '- Prefer casual, natural phrasing over word-for-word literal translations.\n'
        '- Use contractions, slang, and informal expressions where appropriate to match the tone.\n' 
        ...
        '- Make the translation sound like natural spoken language, not a textbook translation.\n'
